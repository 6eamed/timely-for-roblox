...
Public Class Form1
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click 'CREATE FILE BUTTON
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click 'START BUTTON
        Dim FILE_NAME As String 'FILE NAME will be a string
        FILE_NAME = (nameBox.Text & ".6eamed") ' we will give the value to the variable from the textbox
